      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SetColumn(word: "User phone", value: user.userPhone),
            SetColumn(word: "User adress", value: user.userAdress),
            SetColumn(word: "User group", value: "${user.userGroup}"),
            SetColumn(word: "User gender", value: user.userGender),
            SetColumn(word: "User merriage", value: user.userMerriage),
          ],
        ),
      ),
    );
